                ...
                <div class="card">
                    <div class="card-body bg-light">
                        <div class="text-center">
                            <h5>Masuk <span class="gallery alica">Gallery Alica</span></h5>
                        </div>
                        <form action="config/aksi_login.php" method="POST" style="color: #000000;">
                            <label class="form-label">Username</label>
                            <input type="text" name="username" class="form-control" required>
                            <label class="form-label">Password</label>
                            <input type="password" name="password" class="form-control" required>
                            <div class="d-grid mt-2">
                            <button class="btn" style="background-color: #000000; border-color: #000000; color: white;" type="submit" name="kirim">MASUK</button>
                            </div>
                        </form>
                        <hr>
                        <p>Belum punya akun? <a href="register.php" style="color: #000000;">Daftar di sini!</a></p>
                    </div>
                </div>
            </div>
        </div>
